...
public class rough extends JFrame implements ActionListener{
    ...
    JLabel header;
    String username;
    rough(String username)
    {
        setExtendedState(JFrame.MAXIMIZED_BOTH);
        setLayout(null);
        
     ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/elect.jpg"));
    ...
    add(image);
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel1.jpg"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel2.jpg"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel3.jpg"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel5.jpg"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel4.jpg"));
        ...
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel6.jpg"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel4.jpg"));
        ...
        ImageIcon icon8 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel6.jpg"));
        ...
        ImageIcon icon9 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel7.jpg"));
        ...
        ImageIcon icon12 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel1.jpg"));
