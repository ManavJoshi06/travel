...
public class fortf extends JFrame implements ActionListener {
    JButton v,A;
    fortf(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/fort.jpg"));
    ...
    add(image);
     ...
     JLabel text = new JLabel("FORT TREKING");
     text.setBounds(100, 10, 650, 50);
     text.setFont(new Font("Tahoma",Font.BOLD, 50));
     add(text);
     
      JLabel text1 = new JLabel("6 days 5 night ");
     ...
     add(text2);
      ...
      JLabel text3 = new JLabel("Chhatrapti Maharaj");
     text3.setBounds(50, 180, 350, 50);
     text3.setFont(new Font("Tahoma",Font.BOLD, 30));
     add(text3);
     
      JLabel text8 = new JLabel(" Charitra Book");
     text8.setBounds(50, 220, 350, 50);
     text8.setFont(new Font("Tahoma",Font.BOLD, 30));
     add(text8);
     
      JLabel text5 = new JLabel("8 Forts Included");
     text5.setBounds(50, 280, 250, 50);
     text5.setForeground(Color.red);
     text5.setFont(new Font("Tahoma",Font.BOLD, 30));
     add(text5);
     
      JLabel text4= new JLabel("Price  2000/- ");
     text4.setBounds(50, 330, 250 , 50);
