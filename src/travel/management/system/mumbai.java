...
public class mumbai extends JFrame implements Runnable{
     Thread t1;
    ...
    public void run()
    {
        String[] text = new String[]{"Juhu Beach","Siddhivinayak Temple","Worli Seaface","CSMT Station","Aksa Beach","Powai lake","Shivaji Park","ISKCON Temple"};
    ...
    mumbai()
    {
        ...
        for(int i=0; i<=7;i++){
        image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/mumbai"+(i+1)+".jpg"));
