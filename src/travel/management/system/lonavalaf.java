...
public class lonavalaf extends JFrame implements ActionListener {
    JButton v,A;
    lonavalaf(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/lonavala.jpg"));
    ...
    add(image);
     ...
     JLabel text = new JLabel("LONAVALA PACKAGE");
    ...
    JLabel text2 = new JLabel("(All Launguages Speaking Guide) ");
     ...
     add(text2);
      ...
      JLabel text3 = new JLabel(" free chikki(sweet) ");
     text3.setBounds(50, 220, 300, 50);
     text3.setFont(new Font("Tahoma",Font.BOLD, 30));
     add(text3);
     
      JLabel text4= new JLabel("Price  1800/- ");
