...
public class Ashtavinayk extends JFrame implements Runnable{
     Thread t1;
    ...
    public void run()
    {
        String[] text = new String[]{"Moreshwar(Morgaon)","Vighnahar(Ozar)","Siddhivinayk(Siddhatek)","Ballaleshwar(Pali)","VaradVinayk(Mahad)","Chintamani(Theur)","Girijatmaj(Lenyadri)","Mahaganapati(Ranjangaon)"};
    ...
    Ashtavinayk()
    {
        ...
        for(int i=0; i<=7;i++){
        image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/ganesh"+(i+1)+".jpg"));
