...
public class kokanf extends JFrame implements ActionListener {
    JButton v,A;
    kokanf(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/kokan.jpg"));
    ...
    add(image);
     ...
     JLabel text = new JLabel("KOKAN PACKAGE");
     ...
     add(text2);
      ...
      JLabel text3 = new JLabel("Free wooden toys");
