...
public class nashik extends JFrame implements Runnable{
     Thread t1;
    ...
    public void run()
    {
        String[] text = new String[]{"Sula Vineyards","Drushsagar Falls","Trimbakeshwar Temple","Pandavleni Caves","Sita Gumpha","Anjaneri Hills","Dugarwadi Waterfall","Cion Museum"};
    ...
    nashik()
    {
        ...
        for(int i=0; i<=7;i++){
        image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/nashik"+(i+1)+".jpg"));
