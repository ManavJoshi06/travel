...
public class Ashtavinaykf extends JFrame implements ActionListener {
    JButton v,A;
    Ashtavinaykf(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/ganesh3.jpg"));
    ...
    add(image);
     ...
     JLabel text = new JLabel("ASHTAVINAYK PACKAGE");
     text.setBounds(100, 10, 650, 50);
     text.setFont(new Font("Tahoma",Font.BOLD, 50));
     add(text);
     
      JLabel text1 = new JLabel("3 days 2 night ");
     ...
     add(text2);
      ...
      JLabel text3 = new JLabel("Free Ganpati Murti");
     text3.setBounds(50, 220, 350, 50);
     text3.setFont(new Font("Tahoma",Font.BOLD, 30));
     add(text3);
     
      JLabel text4= new JLabel("Price  1500/- ");
