...
public class Destination extends JFrame implements Runnable{
    ...
    public void run()
    {
        String[] text = new String[]{"JM Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","RaddissonBlue Hotel","Classsio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Hotel","River View Hotel"};
