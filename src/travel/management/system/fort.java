...
public class fort extends JFrame implements Runnable{
     Thread t1;
    ...
    public void run()
    {
        String[] text = new String[]{"Raigad ","Purandar ","Shivneri","Sindhudurga","Torna","Lohagad","Pratapgad","Janjira"};
    ...
    fort()
    {
        ...
        for(int i=0; i<=7;i++){
        image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/fort"+(i+1)+".jpg"));
