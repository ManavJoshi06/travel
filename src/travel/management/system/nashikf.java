...
public class nashikf extends JFrame implements ActionListener {
    JButton v,A;
    nashikf(){
    ...
    ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/nashik.jpg"));
    ...
    add(image);
     ...
     JLabel text = new JLabel("NASHIK PACKAGE");
     ...
     add(text2);
      ...
      JLabel text3 = new JLabel("Free Shiv Ling ");
     text3.setBounds(50, 220, 250, 50);
     text3.setFont(new Font("Tahoma",Font.BOLD, 30));
     add(text3);
     
      JLabel text4= new JLabel("Price  1600/- ");
